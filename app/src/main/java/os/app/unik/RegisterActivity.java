                ...
                .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            hashMap.put("bio","");
                            hashMap.put("imageurl","https://firebasestorage.googleapis.com/v0/b/unik-499ee.appspot.com/o/profilelogo.png?alt=media&token=76d1dadd-d1bd-4e32-9888-8329df019aaa");
